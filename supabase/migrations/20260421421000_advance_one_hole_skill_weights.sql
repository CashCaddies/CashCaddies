-- Base birdie/bogey/par from skill_rating; weekend + jitter unchanged after.
...
comment on function public.advance_one_hole() is
  'Birdie/bogey/par base from skill_rating; weekend pressure; jitter + normalize; apply_cut at R2.';
