-- Record which template spawned the contest (see contests.template_id FK).
...
comment on function public.spawn_contest_from_template(uuid, uuid, timestamptz) is
  'Insert contests row from contest_templates; sets template_id; status filling. Admin/senior_admin/founder or service_role.';
