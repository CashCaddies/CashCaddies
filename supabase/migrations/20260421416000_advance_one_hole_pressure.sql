-- Weekend pressure + tri-class probabilities (birdie/par/bogey), then HIO gate and legacy sub-outcomes.
...
comment on function public.advance_one_hole() is
  'Hole RNG: HIO 0.2%; else birdie/par/bogey mix from weekend pressure + rank; nested outcomes unchanged; cut + made_cut rules apply.';
