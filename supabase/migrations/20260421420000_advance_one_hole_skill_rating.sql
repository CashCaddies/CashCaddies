-- Load sim_players.skill_rating per row (default 50) for upcoming skill-based tuning.
...
comment on function public.advance_one_hole() is
  'Loads v_skill from sim_players.skill_rating; hole RNG unchanged until skill wired into weights.';
