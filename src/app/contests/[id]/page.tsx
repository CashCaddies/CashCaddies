    ...
    <div className="pageWrap">
      <div className="goldCard p-6">
        ...
        <div className="mt-4 space-y-2 text-sm text-slate-300">
          <p>
            <span className="text-slate-400">Entry fee:</span> {formatLobbyEntryFeeUsd(row.entry_fee ?? row.entry_fee_usd)}
          </p>
          <p>
            <span className="text-slate-400">Entry count:</span> {entryCount} / {maxEntries}
          </p>
          <p>
            <span className="text-slate-400">Start time:</span> {formatContestStartDate(row.start_time ?? row.starts_at)}
          </p>
