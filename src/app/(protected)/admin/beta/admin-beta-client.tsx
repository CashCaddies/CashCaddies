...
import { approveBetaUser, rejectBetaUser } from "@/app/(protected)/admin/user-actions";
...
export default function AdminBetaApprovalPageClient() {
  ...
  const viewerIsAdmin = Boolean(user);
