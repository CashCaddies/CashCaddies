...
export function DashboardHandleGate({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-[40vh] items-start justify-center pt-8 sm:pt-12">
      <div
        className="mx-4 w-full max-w-lg rounded-xl border border-amber-500/50 bg-slate-950/95 p-6 shadow-xl shadow-black/40 backdrop-blur-sm"
        role="dialog"
        aria-modal="true"
